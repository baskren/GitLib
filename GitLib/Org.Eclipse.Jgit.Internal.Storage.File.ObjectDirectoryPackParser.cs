...
namespace Org.Eclipse.Jgit.Internal.Storage.File {
	...
	/// <summary>Consumes a pack stream and stores as a pack file in <c>ObjectDirectory</c>.</summary>
	// Metadata.xml XPath class reference: path="/api/package[@name='org.eclipse.jgit.internal.storage.file']/class[@name='ObjectDirectoryPackParser']"
	[global::Android.Runtime.Register ("org/eclipse/jgit/internal/storage/file/ObjectDirectoryPackParser", DoNotGenerateAcw=true)]
	public partial class ObjectDirectoryPackParser : global::Org.Eclipse.Jgit.Transport.PackParser {
		static readonly JniPeerMembers _members = new XAPeerMembers ("org/eclipse/jgit/internal/storage/file/ObjectDirectoryPackParser", typeof (ObjectDirectoryPackParser));
		...
		protected ObjectDirectoryPackParser (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer)
		{
		}
...
#pragma warning disable 0169
		...
		{
			var __this = global::Java.Lang.Object.GetObject<global::Org.Eclipse.Jgit.Internal.Storage.File.ObjectDirectoryPackParser> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
			return JNIEnv.ToLocalJniHandle (__this.PackFile);
		}
#pragma warning restore 0169

		/// <summary>Get the imported <c>PackFile</c>.</summary>
		/// <returns>the imported PackFile, if parsing was successful.</returns>
		public virtual unsafe global::Org.Eclipse.Jgit.Internal.Storage.File.PackFile PackFile {
			// Metadata.xml XPath method reference: path="/api/package[@name='org.eclipse.jgit.internal.storage.file']/class[@name='ObjectDirectoryPackParser']/method[@name='getPackFile' and count(parameter)=0]"
			[Register ("getPackFile", "()Lorg/eclipse/jgit/internal/storage/file/PackFile;", "GetGetPackFileHandler")]
			get {
				const string __id = "getPackFile.()Lorg/eclipse/jgit/internal/storage/file/PackFile;";
				try {
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='org.eclipse.jgit.internal.storage.file']/class[@name='ObjectDirectoryPackParser']/method[@name='checkCRC' and count(parameter)=1 and parameter[1][@type='int']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='org.eclipse.jgit.internal.storage.file']/class[@name='ObjectDirectoryPackParser']/method[@name='onAppendBase' and count(parameter)=3 and parameter[1][@type='int'] and parameter[2][@type='byte[]'] and parameter[3][@type='org.eclipse.jgit.transport.PackedObjectInfo']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='org.eclipse.jgit.internal.storage.file']/class[@name='ObjectDirectoryPackParser']/method[@name='onBeginOfsDelta' and count(parameter)=3 and parameter[1][@type='long'] and parameter[2][@type='long'] and parameter[3][@type='long']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='org.eclipse.jgit.internal.storage.file']/class[@name='ObjectDirectoryPackParser']/method[@name='onBeginRefDelta' and count(parameter)=3 and parameter[1][@type='long'] and parameter[2][@type='org.eclipse.jgit.lib.AnyObjectId'] and parameter[3][@type='long']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='org.eclipse.jgit.internal.storage.file']/class[@name='ObjectDirectoryPackParser']/method[@name='onBeginWholeObject' and count(parameter)=3 and parameter[1][@type='long'] and parameter[2][@type='int'] and parameter[3][@type='long']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='org.eclipse.jgit.internal.storage.file']/class[@name='ObjectDirectoryPackParser']/method[@name='onEndThinPack' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='org.eclipse.jgit.internal.storage.file']/class[@name='ObjectDirectoryPackParser']/method[@name='onEndWholeObject' and count(parameter)=1 and parameter[1][@type='org.eclipse.jgit.transport.PackedObjectInfo']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='org.eclipse.jgit.internal.storage.file']/class[@name='ObjectDirectoryPackParser']/method[@name='onInflatedObjectData' and count(parameter)=3 and parameter[1][@type='org.eclipse.jgit.transport.PackedObjectInfo'] and parameter[2][@type='int'] and parameter[3][@type='byte[]']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='org.eclipse.jgit.internal.storage.file']/class[@name='ObjectDirectoryPackParser']/method[@name='onObjectData' and count(parameter)=4 and parameter[1][@type='org.eclipse.jgit.transport.PackParser.Source'] and parameter[2][@type='byte[]'] and parameter[3][@type='int'] and parameter[4][@type='int']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='org.eclipse.jgit.internal.storage.file']/class[@name='ObjectDirectoryPackParser']/method[@name='onObjectHeader' and count(parameter)=4 and parameter[1][@type='org.eclipse.jgit.transport.PackParser.Source'] and parameter[2][@type='byte[]'] and parameter[3][@type='int'] and parameter[4][@type='int']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='org.eclipse.jgit.internal.storage.file']/class[@name='ObjectDirectoryPackParser']/method[@name='onPackFooter' and count(parameter)=1 and parameter[1][@type='byte[]']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='org.eclipse.jgit.internal.storage.file']/class[@name='ObjectDirectoryPackParser']/method[@name='onPackHeader' and count(parameter)=1 and parameter[1][@type='long']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='org.eclipse.jgit.internal.storage.file']/class[@name='ObjectDirectoryPackParser']/method[@name='onStoreStream' and count(parameter)=3 and parameter[1][@type='byte[]'] and parameter[2][@type='int'] and parameter[3][@type='int']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='org.eclipse.jgit.internal.storage.file']/class[@name='ObjectDirectoryPackParser']/method[@name='readDatabase' and count(parameter)=3 and parameter[1][@type='byte[]'] and parameter[2][@type='int'] and parameter[3][@type='int']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='org.eclipse.jgit.internal.storage.file']/class[@name='ObjectDirectoryPackParser']/method[@name='seekDatabase' and count(parameter)=2 and parameter[1][@type='org.eclipse.jgit.transport.PackedObjectInfo'] and parameter[2][@type='org.eclipse.jgit.transport.PackParser.ObjectTypeAndSize']]"
...
#pragma warning disable 0169
		...
		{
			var __this = global::Java.Lang.Object.GetObject<global::Org.Eclipse.Jgit.Internal.Storage.File.ObjectDirectoryPackParser> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
			__this.SetIndexVersion (version);
		}
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='org.eclipse.jgit.internal.storage.file']/class[@name='ObjectDirectoryPackParser']/method[@name='setIndexVersion' and count(parameter)=1 and parameter[1][@type='int']]"
		[Register ("setIndexVersion", "(I)V", "GetSetIndexVersion_IHandler")]
		public virtual unsafe void SetIndexVersion (int version)
		{
		...
		static Delegate cb_setKeepEmpty_Z;
#pragma warning disable 0169
		static Delegate GetSetKeepEmpty_ZHandler ()
		{
			if (cb_setKeepEmpty_Z == null)
				cb_setKeepEmpty_Z = JNINativeWrapper.CreateDelegate ((_JniMarshal_PPZ_V) n_SetKeepEmpty_Z);
			return cb_setKeepEmpty_Z;
		}

		static void n_SetKeepEmpty_Z (IntPtr jnienv, IntPtr native__this, bool empty)
		{
			var __this = global::Java.Lang.Object.GetObject<global::Org.Eclipse.Jgit.Internal.Storage.File.ObjectDirectoryPackParser> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
			__this.SetKeepEmpty (empty);
		}
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='org.eclipse.jgit.internal.storage.file']/class[@name='ObjectDirectoryPackParser']/method[@name='setKeepEmpty' and count(parameter)=1 and parameter[1][@type='boolean']]"
		[Register ("setKeepEmpty", "(Z)V", "GetSetKeepEmpty_ZHandler")]
		public virtual unsafe void SetKeepEmpty (bool empty)
		{
			const string __id = "setKeepEmpty.(Z)V";
			try {
				JniArgumentValue* __args = stackalloc JniArgumentValue [1];
