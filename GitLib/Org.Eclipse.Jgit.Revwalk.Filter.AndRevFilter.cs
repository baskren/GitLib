...
namespace Org.Eclipse.Jgit.Revwalk.Filter {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='org.eclipse.jgit.revwalk.filter']/class[@name='AndRevFilter']"
	[global::Android.Runtime.Register ("org/eclipse/jgit/revwalk/filter/AndRevFilter", DoNotGenerateAcw=true)]
	public abstract partial class AndRevFilter : global::Org.Eclipse.Jgit.Revwalk.Filter.RevFilter {
		static readonly JniPeerMembers _members = new XAPeerMembers ("org/eclipse/jgit/revwalk/filter/AndRevFilter", typeof (AndRevFilter));
		...
		protected AndRevFilter (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer)
		{
		}

		// Metadata.xml XPath constructor reference: path="/api/package[@name='org.eclipse.jgit.revwalk.filter']/class[@name='AndRevFilter']/constructor[@name='AndRevFilter' and count(parameter)=0]"
		[Register (".ctor", "()V", "")]
		public unsafe AndRevFilter () : base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			const string __id = "()V";
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='org.eclipse.jgit.revwalk.filter']/class[@name='AndRevFilter']/method[@name='create' and count(parameter)=1 and parameter[1][@type='java.util.Collection&lt;org.eclipse.jgit.revwalk.filter.RevFilter&gt;']]"
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='org.eclipse.jgit.revwalk.filter']/class[@name='AndRevFilter']/method[@name='create' and count(parameter)=2 and parameter[1][@type='org.eclipse.jgit.revwalk.filter.RevFilter'] and parameter[2][@type='org.eclipse.jgit.revwalk.filter.RevFilter']]"
		...
		/// <summary>Create a filter around many filters, all of which must match.</summary>
		/// <returns>a filter that must match all input filters.</returns>
		// Metadata.xml XPath method reference: path="/api/package[@name='org.eclipse.jgit.revwalk.filter']/class[@name='AndRevFilter']/method[@name='create' and count(parameter)=1 and parameter[1][@type='org.eclipse.jgit.revwalk.filter.RevFilter[]']]"
	...
	[global::Android.Runtime.Register ("org/eclipse/jgit/revwalk/filter/AndRevFilter", DoNotGenerateAcw=true)]
	internal partial class AndRevFilterInvoker : AndRevFilter {
		public AndRevFilterInvoker (IntPtr handle, JniHandleOwnership transfer) : base (handle, transfer)
		{
		}

		static readonly JniPeerMembers _members = new XAPeerMembers ("org/eclipse/jgit/revwalk/filter/AndRevFilter", typeof (AndRevFilterInvoker));
