...
namespace Org.Eclipse.Jgit.Revwalk {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='org.eclipse.jgit.revwalk']/class[@name='FIFORevQueue']"
	[global::Android.Runtime.Register ("org/eclipse/jgit/revwalk/FIFORevQueue", DoNotGenerateAcw=true)]
	public partial class FIFORevQueue : global::Java.Lang.Object {
		static readonly JniPeerMembers _members = new XAPeerMembers ("org/eclipse/jgit/revwalk/FIFORevQueue", typeof (FIFORevQueue));
		...
		protected FIFORevQueue (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer)
		{
		}

		/// <summary>Create an empty FIFO queue.</summary>
		// Metadata.xml XPath constructor reference: path="/api/package[@name='org.eclipse.jgit.revwalk']/class[@name='FIFORevQueue']/constructor[@name='FIFORevQueue' and count(parameter)=0]"
		[Register (".ctor", "()V", "")]
		public unsafe FIFORevQueue () : base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			const string __id = "()V";
...
#pragma warning disable 0169
		...
		{
			var __this = global::Java.Lang.Object.GetObject<global::Org.Eclipse.Jgit.Revwalk.FIFORevQueue> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='org.eclipse.jgit.revwalk']/class[@name='FIFORevQueue']/method[@name='add' and count(parameter)=1 and parameter[1][@type='org.eclipse.jgit.revwalk.RevCommit']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='org.eclipse.jgit.revwalk']/class[@name='FIFORevQueue']/method[@name='clear' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='org.eclipse.jgit.revwalk']/class[@name='FIFORevQueue']/method[@name='next' and count(parameter)=0]"
		...
		static Delegate cb_unpop_Lorg_eclipse_jgit_revwalk_RevCommit_;
#pragma warning disable 0169
		static Delegate GetUnpop_Lorg_eclipse_jgit_revwalk_RevCommit_Handler ()
		{
			if (cb_unpop_Lorg_eclipse_jgit_revwalk_RevCommit_ == null)
				cb_unpop_Lorg_eclipse_jgit_revwalk_RevCommit_ = JNINativeWrapper.CreateDelegate ((_JniMarshal_PPL_V) n_Unpop_Lorg_eclipse_jgit_revwalk_RevCommit_);
			return cb_unpop_Lorg_eclipse_jgit_revwalk_RevCommit_;
		}

		static void n_Unpop_Lorg_eclipse_jgit_revwalk_RevCommit_ (IntPtr jnienv, IntPtr native__this, IntPtr native_c)
		{
			var __this = global::Java.Lang.Object.GetObject<global::Org.Eclipse.Jgit.Revwalk.FIFORevQueue> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
			var c = global::Java.Lang.Object.GetObject<global::Org.Eclipse.Jgit.Revwalk.RevCommit> (native_c, JniHandleOwnership.DoNotTransfer);
			__this.Unpop (c);
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='org.eclipse.jgit.revwalk']/class[@name='FIFORevQueue']/method[@name='unpop' and count(parameter)=1 and parameter[1][@type='org.eclipse.jgit.revwalk.RevCommit']]"
		[Register ("unpop", "(Lorg/eclipse/jgit/revwalk/RevCommit;)V", "GetUnpop_Lorg_eclipse_jgit_revwalk_RevCommit_Handler")]
		public virtual unsafe void Unpop (global::Org.Eclipse.Jgit.Revwalk.RevCommit c)
		{
			const string __id = "unpop.(Lorg/eclipse/jgit/revwalk/RevCommit;)V";
			try {
				JniArgumentValue* __args = stackalloc JniArgumentValue [1];
				__args [0] = new JniArgumentValue ((c == null) ? IntPtr.Zero : ((global::Java.Lang.Object) c).Handle);
				_members.InstanceMethods.InvokeVirtualVoidMethod (__id, this, __args);
