...
namespace Org.Eclipse.Jgit.Revwalk {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='org.eclipse.jgit.revwalk']/class[@name='LIFORevQueue']"
	[global::Android.Runtime.Register ("org/eclipse/jgit/revwalk/LIFORevQueue", DoNotGenerateAcw=true)]
	public partial class LIFORevQueue : global::Java.Lang.Object {
		static readonly JniPeerMembers _members = new XAPeerMembers ("org/eclipse/jgit/revwalk/LIFORevQueue", typeof (LIFORevQueue));
		...
		protected LIFORevQueue (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer)
		{
		}

		/// <summary>Create an empty LIFO queue.</summary>
		// Metadata.xml XPath constructor reference: path="/api/package[@name='org.eclipse.jgit.revwalk']/class[@name='LIFORevQueue']/constructor[@name='LIFORevQueue' and count(parameter)=0]"
		[Register (".ctor", "()V", "")]
		public unsafe LIFORevQueue () : base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			const string __id = "()V";
...
#pragma warning disable 0169
		...
		{
			var __this = global::Java.Lang.Object.GetObject<global::Org.Eclipse.Jgit.Revwalk.LIFORevQueue> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='org.eclipse.jgit.revwalk']/class[@name='LIFORevQueue']/method[@name='add' and count(parameter)=1 and parameter[1][@type='org.eclipse.jgit.revwalk.RevCommit']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='org.eclipse.jgit.revwalk']/class[@name='LIFORevQueue']/method[@name='clear' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='org.eclipse.jgit.revwalk']/class[@name='LIFORevQueue']/method[@name='next' and count(parameter)=0]"
