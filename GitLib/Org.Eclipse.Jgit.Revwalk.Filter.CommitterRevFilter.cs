...
namespace Org.Eclipse.Jgit.Revwalk.Filter {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='org.eclipse.jgit.revwalk.filter']/class[@name='CommitterRevFilter']"
	[global::Android.Runtime.Register ("org/eclipse/jgit/revwalk/filter/CommitterRevFilter", DoNotGenerateAcw=true)]
	public partial class CommitterRevFilter : global::Java.Lang.Object {
		static readonly JniPeerMembers _members = new XAPeerMembers ("org/eclipse/jgit/revwalk/filter/CommitterRevFilter", typeof (CommitterRevFilter));
		...
		protected CommitterRevFilter (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer)
		{
		}
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='org.eclipse.jgit.revwalk.filter']/class[@name='CommitterRevFilter']/method[@name='create' and count(parameter)=1 and parameter[1][@type='java.lang.String']]"
