...
namespace Org.Eclipse.Jgit.Treewalk.Filter {
	...
	/// <summary>Includes a tree entry only if all subfilters include the same tree entry.</summary>
	// Metadata.xml XPath class reference: path="/api/package[@name='org.eclipse.jgit.treewalk.filter']/class[@name='AndTreeFilter']"
	[global::Android.Runtime.Register ("org/eclipse/jgit/treewalk/filter/AndTreeFilter", DoNotGenerateAcw=true)]
	public abstract partial class AndTreeFilter : global::Org.Eclipse.Jgit.Treewalk.Filter.TreeFilter {
		static readonly JniPeerMembers _members = new XAPeerMembers ("org/eclipse/jgit/treewalk/filter/AndTreeFilter", typeof (AndTreeFilter));
		...
		protected AndTreeFilter (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer)
		{
		}

		// Metadata.xml XPath constructor reference: path="/api/package[@name='org.eclipse.jgit.treewalk.filter']/class[@name='AndTreeFilter']/constructor[@name='AndTreeFilter' and count(parameter)=0]"
		[Register (".ctor", "()V", "")]
		public unsafe AndTreeFilter () : base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			const string __id = "()V";
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='org.eclipse.jgit.treewalk.filter']/class[@name='AndTreeFilter']/method[@name='create' and count(parameter)=1 and parameter[1][@type='java.util.Collection&lt;org.eclipse.jgit.treewalk.filter.TreeFilter&gt;']]"
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='org.eclipse.jgit.treewalk.filter']/class[@name='AndTreeFilter']/method[@name='create' and count(parameter)=2 and parameter[1][@type='org.eclipse.jgit.treewalk.filter.TreeFilter'] and parameter[2][@type='org.eclipse.jgit.treewalk.filter.TreeFilter']]"
		...
		/// <summary>Create a filter around many filters, all of which must match.</summary>
		/// <returns>a filter that must match all input filters.</returns>
		// Metadata.xml XPath method reference: path="/api/package[@name='org.eclipse.jgit.treewalk.filter']/class[@name='AndTreeFilter']/method[@name='create' and count(parameter)=1 and parameter[1][@type='org.eclipse.jgit.treewalk.filter.TreeFilter[]']]"
	...
	[global::Android.Runtime.Register ("org/eclipse/jgit/treewalk/filter/AndTreeFilter", DoNotGenerateAcw=true)]
	internal partial class AndTreeFilterInvoker : AndTreeFilter {
		public AndTreeFilterInvoker (IntPtr handle, JniHandleOwnership transfer) : base (handle, transfer)
		{
		}

		static readonly JniPeerMembers _members = new XAPeerMembers ("org/eclipse/jgit/treewalk/filter/AndTreeFilter", typeof (AndTreeFilterInvoker));
