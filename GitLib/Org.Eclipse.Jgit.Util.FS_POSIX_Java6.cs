...
namespace Org.Eclipse.Jgit.Util {
	...
	/// <summary>FS implementation for POSIX systems using Java6</summary>
	// Metadata.xml XPath class reference: path="/api/package[@name='org.eclipse.jgit.util']/class[@name='FS_POSIX_Java6']"
	[global::Android.Runtime.Register ("org/eclipse/jgit/util/FS_POSIX_Java6", DoNotGenerateAcw=true)]
	public partial class FS_POSIX_Java6 : global::Org.Eclipse.Jgit.Util.FS_POSIX {
		static readonly JniPeerMembers _members = new XAPeerMembers ("org/eclipse/jgit/util/FS_POSIX_Java6", typeof (FS_POSIX_Java6));
		...
		protected FS_POSIX_Java6 (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer)
		{
		}

		/// <summary>Constructor</summary>
		// Metadata.xml XPath constructor reference: path="/api/package[@name='org.eclipse.jgit.util']/class[@name='FS_POSIX_Java6']/constructor[@name='FS_POSIX_Java6' and count(parameter)=0]"
		[Register (".ctor", "()V", "")]
		public unsafe FS_POSIX_Java6 () : base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			const string __id = "()V";
		...
		/// <summary>Constructor</summary>
		// Metadata.xml XPath constructor reference: path="/api/package[@name='org.eclipse.jgit.util']/class[@name='FS_POSIX_Java6']/constructor[@name='FS_POSIX_Java6' and count(parameter)=1 and parameter[1][@type='org.eclipse.jgit.util.FS']]"
		[Register (".ctor", "(Lorg/eclipse/jgit/util/FS;)V", "")]
		public unsafe FS_POSIX_Java6 (global::Org.Eclipse.Jgit.Util.FS src) : base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
		...
		/// <returns>true if Java has the ability to set and get the executable flag
		///         on files</returns>
		public static unsafe bool HasExecute {
			// Metadata.xml XPath method reference: path="/api/package[@name='org.eclipse.jgit.util']/class[@name='FS_POSIX_Java6']/method[@name='hasExecute' and count(parameter)=0]"
			[Register ("hasExecute", "()Z", "")]
			get {
				const string __id = "hasExecute.()Z";
				try {
...
#pragma warning disable 0169
		...
		{
			var __this = global::Java.Lang.Object.GetObject<global::Org.Eclipse.Jgit.Util.FS_POSIX_Java6> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='org.eclipse.jgit.util']/class[@name='FS_POSIX_Java6']/method[@name='canExecute' and count(parameter)=1 and parameter[1][@type='java.io.File']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='org.eclipse.jgit.util']/class[@name='FS_POSIX_Java6']/method[@name='newInstance' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='org.eclipse.jgit.util']/class[@name='FS_POSIX_Java6']/method[@name='retryFailedLockFileCommit' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='org.eclipse.jgit.util']/class[@name='FS_POSIX_Java6']/method[@name='setExecute' and count(parameter)=2 and parameter[1][@type='java.io.File'] and parameter[2][@type='boolean']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='org.eclipse.jgit.util']/class[@name='FS_POSIX_Java6']/method[@name='supportsExecute' and count(parameter)=0]"
